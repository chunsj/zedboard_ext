...
static tunable_t tunable_list[] attribute_relro = {
  {TUNABLE_NAME_S(glibc, rtld, nns), {TUNABLE_TYPE_SIZE_T, 1, 16}, {.numval = 4}, NULL, TUNABLE_SECLEVEL_SXID_ERASE, NULL},
  ...
  {TUNABLE_NAME_S(glibc, rtld, optional_static_tls), {TUNABLE_TYPE_SIZE_T, 0, SIZE_MAX}, {.numval = 512}, NULL, TUNABLE_SECLEVEL_SXID_ERASE, NULL},
